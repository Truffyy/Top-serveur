...
<header>
    <section class="hero is-medium is-link mb-6 "
        ...
        <div class="hero-body">
            <p data-text='Ajouter un serveur' class="title titleLogo has-text-centered">
                Ajouter un serveur
            ...
            <div class="card bg-add is-flex is-flex-direction-column ">
                ...
                <form method="post" class="servCreate has-text-centered" enctype="multipart/form-data">
                    ...
                    <div class="card-content">
                        ...
                        <input value="<?php echo $_POST['name'] ?>" type="text" name="name" id="name" required>
                    </div>
                    <div class="card-content">
                    ...
                    <div class="container is-fluid">
                        ...
                        <textarea name="desc" id="image-tools"><?php if (isset($_POST['desc'])){ echo $_POST['desc']; }  ?></textarea>

                    </div>

                    <div class="card-content pb-6">
                        <div class="select">
                            <select id="select1" name="jeu" required >
                                <option>Selectionne ton jeu</option>
                    ...
                    <div class="field pt-6">
                        ...
                        <div class="card-content">
                            <button  class="button is-info is-outlined" value="submit" type="submit" name="submit">
